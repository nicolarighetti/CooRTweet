...
An action $a$ on social media can be formalized as a triple of a user $u$ posting content $p$ at time $t$: 
...
#> Error in eval(expr, envir, enclos): object 'russian_coord_tweets' not found
```
...
result <- detect_coordinated_groups(russian_coord_tweets, 
                                    min_repetition = 5, 
                                    time_window = 10)
#> Error in detect_coordinated_groups(russian_coord_tweets, min_repetition = 5, : object 'russian_coord_tweets' not found
```
...
#> Error in group_stats(result): could not find function "group_stats"
```
...
#> Error in user_stats(result): could not find function "user_stats"
```
