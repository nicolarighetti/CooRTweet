...
Coordinated behavior on social media has been used for political astroturfing [@Keller2020], spreading inappropriate content, and activism. Detecting such behavior is crucial for academic research and investigative journalism. The `CooRTweet` package provides an easy-to-use tool for detecting various coordinated networks on Twitter. The package is powered by `data.table` [@datatable] which makes efficient use of memory and is considerably fast.
